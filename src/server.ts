...
async function startServer(): Promise<void> {
  try {
    ...
    server.listen(PORT, () => {
      ...
      console.log(`✓ Public: GET /api/health, POST /api/auth/login, GET /api/auth/me, POST /api/auth/logout`);
      console.log(`✓ Protected: POST/GET /api/agent/sessions, GET /api/agent/concept-maps, PUT concept-map, POST think, sync-notion, close`);
